                    ...
                    <div className="flex max-w-xl flex-col gap-8">
                        ...
                        <div>
                            <p className="self-stretch font-sans text-base text-white">
                                Wer vor großen Herausforderungen steht und neue
                                Perspektiven mit klaren Impulsen für qualitative
                                Veränderungen will, ist bei ihm genau richtig!
                                <br></br>
                                <br></br> Denn mit Anatoly gehen alle den Weg
                                der Erkenntnisse, welcher über persönliche
                                Transformation zur wahren Selbst-Verwirklichung
                                führt
                                <br></br>
                                <br></br> Spezialisiert auf Achtsamkeitstraining
                                und Steigerung von Bewusstheit fasziniert er
                                seine Teilnehmerkreise mit einsichtsreichen
                        ...
                        <div className=" flex flex-col gap-4 rounded-2xl border border-white border-opacity-10 p-5">
                            ...
                            <ul className="flex flex-col gap-3 text-base text-white">
                                <li>
                                    Außergewöhnliche Fragen und neue Antworten 
                                </li>
                                <li>
                                ...
                                <li>Transzendenz in ein Neues Bewusstsein </li>
                            </ul>
                        </div>
                    </div>
