            ...
            <div className="container">
                <div className="flex flex-col gap-8 lg:gap-12">
                    ...
                    <ul className="flex w-full flex-col justify-center gap-3 self-center lg:flex-row lg:gap-6">
                        <li className="flex h-20 w-full cursor-pointer flex-row items-center justify-between gap-8 rounded-3xl bg-green-900 pb-6 pl-6 pr-6 pt-6 text-white hover:bg-gradient-to-b hover:from-gradientLightStart hover:to-gradientLightEnd hover:text-green-950 lg:h-44 lg:w-60 lg:flex-col lg:justify-center lg:pt-12">
